...
class ConnectorDB:
    def __init__(self, root):
        self.root = root
        self.root.geometry("850x590+300+0")
        self.root.title("Students Management System")
        self.root.resizable(width=False, height=False)
        self.root.iconbitmap("C:\python\Students Register Management\icon.ico")
        ...
        self.title_label.grid(row=0, column=0, padx=132)
        ...
        self.fname_entry = Entry(leftFrame1, width=44, bd=5, font=("times new roman", 15), justify="left", textvariable=fname)
        self.fname_entry.grid(row=1, column=1, sticky=W, padx=5)
        self.lname_entry = Entry(leftFrame1, width=44, bd=5, font=("times new roman", 15), justify="left", textvariable=lname)
        self.lname_entry.grid(row=2, column=1, sticky=W, padx=5)
        self.id_entry = Entry(leftFrame1, width=44, bd=5, font=("times new roman", 15), justify="left", textvariable=stuID)
        self.id_entry.grid(row=3, column=1, sticky=W, padx=5)
        self.phone_entry = Entry(leftFrame1, width=44, bd=5, font=("times new roman", 15), justify="left", textvariable=phone)
        self.phone_entry.grid(row=4, column=1, sticky=W, padx=5)
        self.address_entry = Entry(leftFrame1, width=44, bd=5, font=("times new roman", 15), justify="left", textvariable=address)
